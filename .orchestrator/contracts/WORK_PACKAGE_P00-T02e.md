# WP P00-T02e – Requirements Fill-in Chunk (chapters 64-78)

## Identity
- Version: 1
- Phase: PHASE-00
- Idempotency Key: rw-p00-t02e-v1-20260722
- Branch: feat/00-autorit-t-requirements-und-traceability
- Risk Class: medium
- Status: APPROVED
- Parallel group: T02 fill-in (disjunct write target)
- Note: smaller chunk (64-78) to fit the round budget. Previous wider chunks
  (b: 30-58, c: 59-87) only covered their first ~6 chapters before exhausting rounds.

## Goal
Extract ALL normative requirements from GDD V5 chapters 64..78 into atomic REQ
records, per T02 umbrella + handbook §7. Write ONLY to your staging file.

## Sole Write Target (DISJUNCT)
docs/requirements/requirements/_staging/chunk-e.json
(shape: {"schemaVersion":"1.0","chunk":"e","chapterRange":{"lo":64,"hi":78},"requirements":[...],"contextOnly":[...]})

## Read Inputs (SMALL, FOCUSED per-chapter files)
- docs/requirements/generated/chapters/chapter-64.txt ... chapter-78.txt (one small file per chapter)
...
- TEMP id REQ-TEMP-E-0001.. per record.
...
## Out of Scope: chapters outside 64-78. Final IDs (merge). Category files.

## Acceptance: chunk file valid JSON; every chapter 64-78 has req or context-only; quoteHash correct.
