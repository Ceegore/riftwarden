# WP P00-T02f – Requirements Fill-in Chunk (chapters 79-87)

## Identity
- Version: 1
- Phase: PHASE-00
- Idempotency Key: rw-p00-t02f-v1-20260722
- Branch: feat/00-autorit-t-requirements-und-traceability
- Risk Class: medium
- Status: APPROVED
- Parallel group: T02 fill-in (disjunct write target)
- Note: smaller chunk (79-87) to fit the round budget. Previous wider chunks
  (b: 30-58, c: 59-87) only covered their first ~6 chapters before exhausting rounds.

## Goal
Extract ALL normative requirements from GDD V5 chapters 79..87 into atomic REQ
...
(shape: {"schemaVersion":"1.0","chunk":"f","chapterRange":{"lo":79,"hi":87},"requirements":[...],"contextOnly":[...]})

## Read Inputs (SMALL, FOCUSED per-chapter files)
- docs/requirements/generated/chapters/chapter-79.txt ... chapter-87.txt (one small file per chapter)
...
- TEMP id REQ-TEMP-F-0001.. per record.
...
## Out of Scope: chapters outside 79-87. Final IDs (merge). Category files.

## Acceptance: chunk file valid JSON; every chapter 79-87 has req or context-only; quoteHash correct.
