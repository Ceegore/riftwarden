...
/**
 * Writes JSON to a repo-relative path.
...
/**
 * Reads JSON from a repo-relative path.
 * @param {string} root Repository root.
 * @param {string} relative Repository-relative path.
 * @returns {Promise<any>}
 */
...
/**
 * Runs the validator CLI in a child process.
 * @param {string} root Repository root (cwd for the child).
