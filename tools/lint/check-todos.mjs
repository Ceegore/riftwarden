...
function walk(dir) {
  ...
  for (const entry of fs.readdirSync(dir, { withFileTypes: true })) {
    if (entry.name === 'generated' || entry.name === 'node_modules' || entry.name === 'lint' || entry.name === 'requirements' || entry.name === 'locales' || entry.name === 'ui' || entry.name === 'navigation') continue;
