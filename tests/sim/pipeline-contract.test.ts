...
const requiredTypes = [
  ...
  'AttackPrepared', 'AttackInterrupted', 'AttackCommitted', 'AttackRecoveryStarted', 'AttackCycleCompleted', 'ProjectileSpawned', 'DamageApplied', 'HealApplied', 'ShieldApplied', 'ShieldAbsorbed', 'ShieldExpired', 'EffectApplied', 'EffectRemoved',
...
describe('event contract', () => {
  it('46 required event types are registered with valid categories', () => {
