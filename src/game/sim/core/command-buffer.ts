...
const ALLOWED: Readonly<Record<PipelineStage,readonly KernelCommand['kind'][]>> = Object.freeze({
  ...
  G:['set_timer','schedule_event','set_attack_state','set_attack_lifecycle','set_attack_instance_seq','set_attack_interval_ready','append_event'], H:['schedule_event','append_event'],
