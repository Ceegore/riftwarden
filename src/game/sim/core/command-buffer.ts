...
const ALLOWED: Readonly<Record<PipelineStage,readonly KernelCommand['kind'][]>> = Object.freeze({
  ...
  K:['spawn_entity','remove_entity','set_position','set_global_progress','set_statuses','append_event'], L:['battle_transition','set_time_collapse','apply_lp_delta','append_event'], M:['checkpoint_marker']
});
